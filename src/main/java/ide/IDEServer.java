                        ...
                        if (ideSession != null) {
                            ...
                            if (type.equals(InsertEvent.INSERT_EVENT_TYPE)) {
                                ...
                                for (IDESession sessionToAddDevTo : currentIDESessions.values()) {
                                    ...
                                    devGroup = sessionToAddDevTo.getDatabase().addADeveloperAndCreateANewDeveloperGroup(
                                            creationDate, firstName, lastName, email, sessionToAddDevTo.getCurrentNode().getId(), sessionToAddDevTo.getLoggedInDevGroupId()).a;
                                }
