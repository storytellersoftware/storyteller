...
//
///**
// * A superclass of anything that needs to render the JSON output by the server.
// * 
// * subclasses will be in charge of getting the events once a connection has been established
// * @author Kevin
// *
// */
//public abstract class StorytellerEventRenderer
//{
...
//
//	public StorytellerEventRenderer(String pathToServer)
//	{
